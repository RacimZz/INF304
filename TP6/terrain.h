...
typedef enum { LIBRE, EAU, ROCHER , ROBOT} Case;
...
typedef enum { OK, ERREUR_FICHIER, ERREUR_LARGEUR, ERREUR_HAUTEUR, ERREUR_ROBOT_INEXISTANT, ERREUR_CARACTERE } erreur_terrain;
